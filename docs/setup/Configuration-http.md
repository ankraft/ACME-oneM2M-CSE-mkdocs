...
|:--------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| enable                    | Enable the HTTP binding.                                                                                                                                                                                                                                                                                                                                                                                                           | True                                                                                                                                                                  |
...
| externalRoot              | External root. This is used when the CSE is accessed from external addresses, e.g. in a Kubernetes cluster. It should only be set when the external root path is different from the local root.<br /> Default: same as the *root* setting                                                                                                                                                                                          | ${http:root}                                                                                                                                                          |
