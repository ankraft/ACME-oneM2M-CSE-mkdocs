...
| enableBasicAuth   | Enable basic authentication for the HTTP binding. See [HTTP Basic Authentication](../setup/Certificates.md#basic-authentication).                                                                                            | False                                                                                                          | http.security.enableBasicAuth   |
| enableTokenAuth   | Enable token authentication for the HTTP binding. See [HTTP Token Authentication](../setup/Certificates.md#token-authentication).                                                                                            | False                                                                                                          | http.security.enableTokenAuth   |
