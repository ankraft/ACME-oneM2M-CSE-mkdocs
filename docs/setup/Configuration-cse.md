...
| resourcesPath                          | Directory of the CSE's *init* directory that hosts resources, policies, and other settings to import.<br/>See also command line argument [–-init-directory](../setup/Running.md#command-line-arguments). | [${basic.config:initDirectory}](../setup/Configuration-introduction.md#settings-interpolation) |
