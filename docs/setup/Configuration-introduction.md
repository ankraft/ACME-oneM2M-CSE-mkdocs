...
| ACME_CSE_REGISTRAR_SECURITY_HTTPUSERNAME     | Username for HTTP Basic Authentication with the registrar CSE                                                                                                                                                               | [\[cse.registrar.security\].httpUsername](./Configuration-cse.md#registrar-cse-security-settings)    |
