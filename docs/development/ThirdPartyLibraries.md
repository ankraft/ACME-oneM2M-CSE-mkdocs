...
- [kazoo](https://github.com/python-zk/kazoo){target=_new} is a high-level library to access Zookeeper. Apache License 2.0.
...
- [websockets](https://github.com/python-websockets/websockets){target=_new} is a library for building WebSocket servers and clients in Python. MIT License.
...
- [textual-plotext](https://github.com/textualize/textual-plotext){target=_new} is a plugin for integrating Plotext with Textual. MIT License.
